...
class ExportExcelDataCommand extends AbstractCommand
{
    protected $signature = 'drc:dboutexcel {database?} {--path=} {--ignore=} {--select=}';
    ...
    public function handle()
    {
        ...
        $filename = (empty($path)) ? config('drc.exportConfig.excel.seed').'database.xlsx' : $this->path.'database.xlsx';
